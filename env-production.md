...
## 🚀 Frontend Deployment
**URL**: `https://ai-based-todo.vercel.app/`
...
| `BETTER_AUTH_URL` | `https://ai-based-todo.vercel.app` | The URL of your frontend deployment. |
| `NEXT_PUBLIC_API_URL` | `https://evaluation-todo.vercel.app` | The URL of your backend deployment. |
| `NEXT_PUBLIC_AUTH_URL` | `https://ai-based-todo.vercel.app` | Same as `BETTER_AUTH_URL` for client-side access. |
